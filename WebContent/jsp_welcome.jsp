		...
		<div class="center_content">
			<div class="left_content">
				...
				<div class="feat_prod_box">
					...
					<div class="prod_img">
						<a href="#"><img src="images/prod1.gif" alt="" title=""
							border="0" />
						</a>
					</div>
				...
				<div class="feat_prod_box">
					...
					<div class="prod_img">
						<a href="#"><img src="images/get.gif" alt="" title=""
							border="0" />
						</a>
					</div>
				...
				<div class="new_products">
					...
					<div class="new_prod_box">
						<a href="details.html">The Complete Reference:JAVA</a>
						<div class="new_prod_bg">
							<span class="new_icon"><img src="images/new_icon.gif"
								alt="" title="" />
							</span> <a href="#"><img src="images/java.gif" alt="" title=""
					...
					<div class="new_prod_box">
						...
						<div class="new_prod_bg">
							<span class="new_icon"><img src="images/new_icon.gif"
								alt="" title="" />
							</span> <a href="#"><img src="images/letusc.gif" alt="" title=""
								class="thumb" border="0" />
							</a>
						</div>
					</div>

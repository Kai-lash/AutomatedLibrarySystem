...
<%@page import="book.servlet_bookRequest" errorPage="jsp_errorPageLib.jsp"%>
...
<script type="text/javascript">
	function toExcel() {
		...
		location.replace("excel_reportMemCollection.jsp?span=" + span
				+ "&month=" + month + "&year=" + year);
	}
	function refresh() {
		span = document.forms[0].span.value;
		location.replace("jsp_reportMemCollection.jsp?span=" + span);
	}
	...
	function refresh1() {
		...
		span = document.forms[0].span.value;
		year = document.forms[0].year.value;
		location.replace("jsp_reportMemCollection.jsp?span=" + span + "&month="
				+ month + "&year=" + year);
	}
	...
	function refresh2() {
		span = document.forms[0].span.value;
		year = document.forms[0].year.value;
		location.replace("jsp_reportMemCollection.jsp?span=" + span + "&year="
				+ year );
	}
				...
				<div class="feat_prod_box_details">
					...
					<div class="title">
						<span class="title_icon"><img src="images/bullet1.gif"
							alt="" title="" /> </span>List of Membership Collection
					</div>
					<!--  <div class="contact_form">-->
					<div class="form_subtitle">List of Membership Collection</div>
					<form action="">
						<br></br>
						...
						<table align="center" class="cart_table1" border="1">
							<tr class="cart_title">
								...
								<td colspan="2">Membership Collection report</td>
								<td><select name="span" onchange="refresh()">
